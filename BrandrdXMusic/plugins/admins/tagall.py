...
TAGMES = [ " **𝐲𝐨𝐮 𝐬𝐨 𝐜𝐮𝐭𝐞 🤭❤️ 𝐛𝐚𝐛𝐲** ",
           " **𝐇𝐦𝐦 𝐥𝐨𝐨𝐬𝐞 𝐞𝐧𝐧𝐚 𝐩𝐚𝐧𝐝𝐫𝐚** ",
           " **𝐇𝐚𝐢𝐢 𝐓𝐞𝐚 𝐊𝐮𝐝𝐢𝐜𝐡𝐚 ✨** ",
           " **🥺🥺 𝐞𝐧 𝐌𝐞𝐥𝐚 𝐩𝐚𝐲𝐚𝐬𝐚𝐦 𝐢𝐥𝐥𝐚 𝐚𝐡𝐡 𝐮𝐧𝐧𝐚𝐤𝐮** ",
           " **𝐓𝐨𝐦𝐨𝐫𝐫𝐨𝐰 𝐦𝐨𝐫𝐧𝐢𝐧𝐠 𝐦𝐚𝐫𝐫𝐢𝐚𝐠𝐞 ❤️ 𝐓𝐨𝐦𝐨𝐫𝐫𝐨𝐰 𝐧𝐢𝐠𝐡𝐭 𝐟𝐢𝐫𝐬𝐭 𝐧𝐢𝐠𝐡𝐭 🌙 🫣🤭💋** ",
           " **𝐨𝐢𝐢 𝐝𝐦 𝐯𝐚 🤭** ",
           " **𝐈 𝐥𝐨𝐯𝐞 ❤️ 𝐲𝐨𝐮 𝐛𝐚𝐛𝐲 🫣🤭** ",
           " **𝐏𝐞𝐚 𝐩𝐚𝐢𝐭𝐡𝐢𝐲𝐚𝐦** ",
           " **𝐎𝐳𝐡𝐮𝐧𝐠𝐚 𝐯𝐚𝐧𝐭𝐡𝐮 𝐠𝐫𝐩 𝐥𝐚 𝐩𝐞𝐬𝐮𝐧𝐠𝐚 😏🥱** ",
           " **𝐯𝐚𝐧𝐚𝐤𝐚𝐦 𝐝𝐚 𝐦𝐚𝐩𝐥𝐚 𝐕𝟐 𝐥𝐚 𝐢𝐫𝐢𝐭𝐡𝐮** ",
           " **𝐇𝐞𝐥𝐥𝐨 𝐛𝐚𝐛𝐲,𝐞𝐧𝐧𝐚 𝐩𝐚𝐧𝐝𝐫𝐚,𝐒𝐚𝐩𝐭𝐢𝐲𝐚** ",
           " **𝐂𝐨𝐟𝐟𝐞𝐞 𝐤𝐮𝐝𝐢𝐜𝐡𝐮𝐭𝐭𝐢𝐧𝐠𝐚𝐥𝐚 ☕️** ",
           " **𝐊𝐚𝐧𝐧𝐚 𝐩𝐨𝐨𝐜𝐡𝐢 𝐫𝐞𝐡𝐡 𝐫𝐞𝐡𝐡𝐡😁🫣** ",
           " **𝐍𝐚 𝐮𝐧𝐧𝐚 𝐞𝐧𝐠𝐚 𝐲𝐨 𝐩𝐚𝐭𝐡𝐮 𝐢𝐫𝐮𝐤𝐤𝐚🧐🤔** ",
           " **𝐍𝐞𝐞𝐠𝐚 𝐬𝐢𝐧𝐠𝐥𝐞 𝐥𝐚 𝐜𝐨𝐦𝐦𝐢𝐭𝐭𝐞𝐝 𝐝𝐚** ",
           " **👀😵‍💫 𝐟𝐞𝐞𝐥 𝐩𝐚𝐧𝐧𝐚𝐭𝐡𝐞𝐞𝐧𝐠𝐚 𝐭𝐚𝐠 𝐧𝐚𝐚𝐧 𝐩𝐚𝐧𝐝𝐫𝐞𝐧 🤧** ",
           " **𝐘𝐞𝐥𝐚𝐦 𝐠𝐫𝐨𝐮𝐩 𝐥𝐚 𝐧𝐞𝐞 𝐢𝐫𝐮𝐩𝐚 𝐧𝐚 𝐢𝐫𝐮𝐤𝐚 𝐤𝐨𝐝𝐚𝐭𝐡𝐮 𝐚𝐡** ",
           " **𝐁𝐚𝐥𝐚𝐧𝐜𝐞 𝐢𝐥𝐥𝐚 𝐩𝐨𝐭𝐭𝐮 𝐯𝐢𝐝𝐮 𝐥𝐞𝐲 🥲🥲** ",
           " **𝐃𝐨 𝐘𝐨𝐮 𝐊𝐧𝐨𝐰 𝐖𝐡𝐨 𝐈𝐬 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 [@OWNEROFTHEDENKI].?** ",
           " **𝐍𝐞𝐞 𝐕𝐚𝐫𝐚𝐥𝐚𝐧𝐚 𝐮𝐧𝐚 𝐭𝐡𝐞𝐝𝐢 𝐧𝐚𝐚𝐧 𝐯𝐚𝐫𝐚 𝐯𝐚𝐧𝐝𝐢 𝐢𝐫𝐮𝐤𝐮𝐦 𝐩𝐚𝐭𝐡𝐮𝐤𝐨✨☺️** ",
           " **𝐔𝐧 𝐤𝐢𝐭𝐭𝐚 𝐨𝐧𝐧𝐮 𝐤𝐞𝐤𝐮𝐧𝐮𝐦** ",
